...
export const products: Product[] = [
  ...
  },
  {
    ...
    brand: "SATEC",
    category: "Meters & Analyzers",
    description: "Power quality analyzer multifungsi untuk analisis kualitas daya.",
  ...
  {
    slug: "pm130-plus",
    name: "PM130 PLUS LED Panel Meter",
    brand: "SATEC",
    category: "Meters & Analyzers",
  ...
  {
    slug: "bfm136",
    name: "BFM136 Multi-Circuit Energy Meter",
    brand: "SATEC",
    category: "Meters & Analyzers",
    description: "Meter energi multi-sirkuit hingga 36 kanal arus.",
  ...
  {
    slug: "bfm-ii",
    name: "BFM-II Multi-circuit Power Meter",
    brand: "SATEC",
    category: "Meters & Analyzers",
    description: "Meter daya multi-sirkuit hingga 54 kanal arus.",
  ...
  {
    slug: "bfm-dfr",
    name: "BFM-DFR Multi-Circuit Fault Recorder",
    brand: "SATEC",
    category: "Meters & Analyzers",
    description: "Perekam gangguan multi-sirkuit (40-channel waveform).",
