...
const services = [
  {
    ...
    image: "https://images.unsplash.com/photo-1555529669-4b1db1cb2e1c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    features: [
          ...
          <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-lg shadow-md text-center">
                ...
                <h3 id="flooring" className="text-xl font-semibold mb-4">Flooring Solutions</h3>
                <p className="text-gray-600">Discover the perfect flooring for your space with unbeatable prices on top-brand materials.</p>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-md text-center">
                ...
                <h3 id="installation" className="text-xl font-semibold mb-4">Professional Installation</h3>
                <p className="text-gray-600">Expert installation services with lifetime warranty and skilled craftsmanship.</p>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-md text-center">
                ...
                <h3 id="consultation" className="text-xl font-semibold mb-4">Design Consultation</h3>
                <p className="text-gray-600">Professional design consultation with knowledgeable and friendly staff to assist you.</p>
              </div>
            </div>
          </div>
        </section>
