    ...
    <footer className="bg-gray-800 text-white py-16">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          {/* Company Info */}
          <div>
            <h3 className="text-lg font-semibold mb-6">EZON RENOVATION PTE.LTD.</h3>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:info@ezonrenovation.com" className="text-gray-300 hover:text-primary transition-colors">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="tel:+6565261797" className="text-gray-300 hover:text-primary transition-colors">
                  +65 6526 1797
                </a>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="https://api.whatsapp.com/send?phone=6594513098" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-green-500 transition-colors">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="text-gray-300">Shopping Mall Renovation</div>
              <div className="text-gray-300">Commercial Renovation</div>
              <div className="text-gray-300">House - Childcare - Villa</div>
              <div className="text-gray-300">Professional Installation</div>
              <div className="text-gray-300">Flooring Solutions</div>
            </div>
            <Link
              href="/services"
              className="text-primary hover:text-primary/80 transition-colors font-medium inline-flex items-center mt-4"
            >
              View All Services →
            </Link>
          </div>
